...
TRANSLATIONS = {
    "en": {
        ...
        "reset_confirm": "RESET",
        "home_confirm_title": "Are you sure you want to return to the home page?",
        "home_confirm_body": "Your current game progress will not be saved.",
    ...
    "vi": {
        ...
        "reset_confirm": "CHƠI LẠI",
        "home_confirm_title": "Bạn có chắc chắn muốn trở về trang chính không?",
        "home_confirm_body": "Tiến trình ván chơi hiện tại sẽ không được giữ lại.",
