...
class ModeSelectPage:
    ...
    def draw_panel(self):
        ...
        title_font = get_ui_font(self.sf(72), bold=True, serif=True)
        title = title_font.render(self.preferences.text("levels_title"), True, BLACK)
        title_rect = title.get_rect(center=(x + w // 2, self.sy(250)))
